...
import { Layers, Brush, Settings, Download } from 'lucide-react';

const Sidebar = () => {
  const { activeLayer, setLayer, activeTool, setActiveTool } = useUIStore();
  const [activeTab, setActiveTab] = useState('layers');

  console.log('Sidebar render:', { activeTool, activeLayer });

  return (
    <div className="absolute right-0 top-0 h-full w-80 bg-gray-800 border-l border-gray-700 shadow-xl flex flex-col z-20 pointer-events-auto">
